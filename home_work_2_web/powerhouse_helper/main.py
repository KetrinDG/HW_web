...
from .Note_Book_Handler import (
    NoteBot,
    performer as n_performer,
    get_handler as n_get_handler,
)
...
def address_book():
    ...
    address_book_completer = WordCompleter(
        [
            "help",
            "add",
            "search",
    ...
    print(
        '\033[32mYou have entered the address book. Enter your command ("help" to get a description of the commands)'
    )
    while True:
...
def note_book():
    ...
    note_book_completer = WordCompleter(
        [
            "help",
            "add note",
            "add date",
    ...
    print(
        '\033[32mYou have entered the note book. Enter your command ("help" to get a description of the commands)'
    )
    while True:
...
def run():
 ...
 |_|       \___/    \_/\_/    \___| |_|    |_| |_|  \___/   \__,_| |___/  \___|   |_|  |_|  \___| |_| | .__/   \___| |_|   
    ...
    while True:
        ...
        main_action = prompt(
            """You are in the main menu! Please select the section you need.\n> address book\n> note book\n> folder sorter\n> calculator\n> snake\n> exit\n>>> """,
